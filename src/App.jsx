...
const App = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?w=300" alt="Principal" className="w-full md:w-48 h-48 object-cover rounded-lg" />
          <div>
            ...
            <p className="text-gray-700 font-semibold">
              - Mr. Abhishek Srivastava, Principal
            </p>
          </div>
        </div>
      </div>
  ...
  const AdmissionsPage = () => (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-purple-50 p-6 rounded-lg">
          ...
          <div className="text-gray-700 space-y-2">
            <p><span className="font-semibold">Primary (1-5):</span> ₹30,000/year</p>
            <p><span className="font-semibold">Middle (6-8):</span> ₹40,000/year</p>
            <p><span className="font-semibold">Senior (9-12):</span> ₹45,000/year</p>
      ...
      <form onSubmit={handleAdmissionSubmit} className="bg-white rounded-lg shadow-lg p-8">
  ...
  const ContactPage = () => (
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        ...
        <form onSubmit={handleContactSubmit} className="bg-white rounded-lg shadow-lg p-6">
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
          ...
          <p className="mt-2 text-xs">Developed by <span className="text-blue-400 font-semibold">Vikash Kumar Jha</span></p>
        </div>
      </div>
    </footer>
  );
